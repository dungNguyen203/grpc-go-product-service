...
const file_rpc_verify_email_proto_rawDesc = "" +
	"\n" +
	"\x16rpc_verify_email.proto\x12\x02pb\"C\n" +
	"\x12VerifyEmailRequest\x12\x19\n" +
	"\bemail_id\x18\x01 \x01(\x03R\aemailId\x12\x12\n" +
	"\x04code\x18\x02 \x01(\tR\x04code\"6\n" +
	"\x13VerifyEmailResponse\x12\x1f\n" +
	"\vis_verified\x18\x01 \x01(\bR\n" +
	"isVerifiedB;Z9github.com/dungNguyen203/grpc-go-product-service/proto/pbb\x06proto3"
